  ...
  return (
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.logoBackground}>
        <Image source={require('../assets/images/ai-safe-route-logo-v6.png')} style={styles.logo} />
      </View>
      ...
      <PasswordInput value={password} onChangeText={setPassword} placeholder="비밀번호를 입력해 주세요" placeholderTextColor="#7A8984" textContentType="password" autoComplete="current-password" returnKeyType="done" onSubmitEditing={() => void submit()} style={styles.passwordInput} />
...
const styles = StyleSheet.create({
  ...
  logoBackground: { alignSelf: 'center', width: 112, height: 104, marginTop: 28, alignItems: 'center', justifyContent: 'center' },
